...
既然安装好了 Rust，我们来编写第一个 Rust 程序 Hello，world！
...
接下来，新建一个Rust源文件，命名为 *main.rs*。Rust 源文件总是以 *.rs* 扩展名结尾。如果文件名包含多个单词，使用**下划线**分隔它们。例如命名为 *hello_world.rs*，而不是 *helloworld.rs*。
